...
interface Post {
  ...
  likes: number;
  musicSrc: string;
  startTime: number; // <-- Nova propriedade para o tempo de início
}

const InstagramSection: React.FC = () => {
  const posts: Post[] = [
    // Defina o startTime em segundos para cada música
    { src: '/images/fotodela1.PNG', alt: 'Ela sorrindo', comment: "A beleza que herda a força e a realeza de gerações. Cada traço seu conta uma história de poder. Linda demais!", likes: 123, musicSrc: '/music/musica1.mp3', startTime: 15 },
    { src: '/images/fotodela2.PNG', alt: 'Foto em close', comment: "Essa pele é poesia. O tom que o sol beija e a noite admira. ✨", likes: 234, musicSrc: '/music/musica2.mp3', startTime: 50 },
    { src: '/images/fotodela4.PNG', alt: 'Look do dia', comment: "Como pode um ser humano ser tão perfeitamente esculpido? A beleza preta em sua forma mais pura.", likes: 345, musicSrc: '/music/musica3.mp3', startTime: 18 },
    { src: '/images/fotodela3.PNG', alt: 'Momento descontraído', comment: "Não sei o que brilha mais, o sol ou o seu sorriso. Acho que já sei a resposta.", likes: 456, musicSrc: '/music/musica4.mp3', startTime: 45 },
    { src: '/images/fotodela5.PNG', alt: 'Selfie', comment: "Tem gente que é bonita. E tem você, que redefine o conceito. A melanina mais linda que já vi.", likes: 567, musicSrc: '/music/musica5.mp3', startTime: 90 },
  ];
  ...
  useEffect(() => {
    ...
    if (selectedPost && audio) {
      audio.src = selectedPost.musicSrc;
      
      const playAudio = () => {
        audio.currentTime = selectedPost.startTime; // Define o tempo de início
        audio.play();
        // Remove o "ouvinte" para não ser disparado novamente
        audio.removeEventListener('loadeddata', playAudio);
      };
      
      // Adiciona um "ouvinte" para tocar a música assim que ela carregar
